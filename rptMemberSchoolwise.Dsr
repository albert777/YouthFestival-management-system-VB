VERSION 5.00
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} rptMemberSchoolwise 
   Bindings        =   "rptMemberSchoolwise.dsx":0000
   Caption         =   "DataReport1"
   ClientHeight    =   11010
   ClientLeft      =   60
   ClientTop       =   450
   ...
   TopMargin       =   1440
   BottomMargin    =   1440
   DataMember      =   "cmdMemberSchoolwise"
   NumSections     =   5
   SectionCode0    =   1
   BeginProperty Section0 {1C13A8E0-A0B6-11D0-848E-00A0C90DC8A9} 
      ...
      BeginProperty Item9 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         EndProperty
         ForeColor       =   128
         Object.Caption         =   "SCHOOLWISE REPORT"
         Alignment       =   2
      EndProperty
      ItemType10      =   7
      BeginProperty Item10 {1C13A8E5-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         Object.Width           =   1860
         Object.Height          =   2160
         Picture         =   "rptMemberSchoolwise.dsx":001F
      EndProperty
   EndProperty
   SectionCode1    =   2
   ...
   EndProperty
End
Attribute VB_Name = "rptMemberSchoolwise"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Private Sub DataReport_Initialize()
    DataEnvironment1.cmdMemberSchoolwise frmSchoolwise.cmbSchool.ItemData(frmSchoolwise.cmbSchool.ListIndex)
    ...
    If rsprofile.EOF = False Then
        rptMemberSchoolwise.Sections(1).Controls(1).Caption = rsprofile.Fields("title1")
        rptMemberSchoolwise.Sections(1).Controls(2).Caption = rsprofile.Fields("title2")
        rptMemberSchoolwise.Sections(1).Controls(3).Caption = rsprofile.Fields("title3")
        rptMemberSchoolwise.Sections(1).Controls(4).Caption = rsprofile.Fields("phone")
        rptMemberSchoolwise.Sections(1).Controls(5).Caption = rsprofile.Fields("email")
        rptMemberSchoolwise.Sections(1).Controls(6).Caption = rsprofile.Fields("fax")
    End If
...
Private Sub DataReport_Terminate()
    DataEnvironment1.rscmdMemberSchoolwise.Close
End Sub
