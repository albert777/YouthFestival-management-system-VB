VERSION 5.00
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} rptProgram 
   Bindings        =   "rptProgram.dsx":0000
   Caption         =   "DataReport1"
   ClientHeight    =   11010
   ClientLeft      =   60
   ClientTop       =   450
...
Private Sub DataReport_Initialize()
    ...
    If rsprofile.EOF = False Then
        rptProgram.Sections(1).Controls(1).Caption = rsprofile.Fields("title1")
        rptProgram.Sections(1).Controls(2).Caption = rsprofile.Fields("title2")
        rptProgram.Sections(1).Controls(3).Caption = rsprofile.Fields("title3")
        rptProgram.Sections(1).Controls(4).Caption = rsprofile.Fields("phone")
        rptProgram.Sections(1).Controls(5).Caption = rsprofile.Fields("email")
        rptProgram.Sections(1).Controls(6).Caption = rsprofile.Fields("fax")
    End If
