VERSION 5.00
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} rptMemberPgmwise 
   Bindings        =   "rptMemberPgmwise.dsx":0000
   Caption         =   "DataReport1"
   ClientHeight    =   11010
   ClientLeft      =   60
   ClientTop       =   450
   ...
   BeginProperty Section0 {1C13A8E0-A0B6-11D0-848E-00A0C90DC8A9} 
      ...
      BeginProperty Item9 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         EndProperty
         ForeColor       =   128
         Object.Caption         =   "PROGRAMWISE REPORT"
         Alignment       =   2
      EndProperty
      ItemType10      =   7
      BeginProperty Item10 {1C13A8E5-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         Object.Width           =   2016
         Object.Height          =   2160
         Picture         =   "rptMemberPgmwise.dsx":001F
      EndProperty
   EndProperty
   SectionCode1    =   2
   ...
   EndProperty
End
Attribute VB_Name = "rptMemberPgmwise"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Private Sub DataReport_Initialize()
    DataEnvironment1.cmdMemberPgmwise frmProgramwise.cmbProgram.ItemData(frmProgramwise.cmbProgram.ListIndex)
    ...
    If rsprofile.EOF = False Then
        rptMemberPgmwise.Sections(1).Controls(1).Caption = rsprofile.Fields("title1")
        rptMemberPgmwise.Sections(1).Controls(2).Caption = rsprofile.Fields("title2")
        rptMemberPgmwise.Sections(1).Controls(3).Caption = rsprofile.Fields("title3")
        rptMemberPgmwise.Sections(1).Controls(4).Caption = rsprofile.Fields("phone")
        rptMemberPgmwise.Sections(1).Controls(5).Caption = rsprofile.Fields("email")
        rptMemberPgmwise.Sections(1).Controls(6).Caption = rsprofile.Fields("fax")
    End If
    
End Sub

Private Sub DataReport_Terminate()
    DataEnvironment1.rscmdMemberPgmwise.Close
